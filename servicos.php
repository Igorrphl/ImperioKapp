...
<html lang="pt-br">
    ...
    <body style="text-align: center;color: white;background-color: black;">
        ...
        <h1 style="font-size: 25px;font-weight: 700;color: #c89637;">Nossa Loja</h1>
<?php
		...
		while($ln = mysqli_fetch_assoc($query))
		{
			...
			echo '<h2 style="font-weight: 500;font-size:20px;">'.$ln['nome'].'</h2> <br />';
			...
			//Mostrando o valor da posição 'nome' do vetor "$ln"
			echo '<a href="carrinho.php?acao=add&id='.$ln['id'].'" style="font-size: 20px;font-weight: 500;color: #c89637;">Comprar</a>';
			
			echo '<br /><hr />';
		}
		echo '<a href="logout.php" style="font-size: 20px;font-weight: 900;color: #ffffff;">Sair</a>';
?>	 
   <!-- FINAL --> 
